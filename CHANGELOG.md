...
### v6.0.3/6.0.4/6.0.5/6.0.6/6.0.7
...
- Afterpay logo is too small

- parseMode cannot be set to ‘period’ 
...
- predictBackgroundTheme always takes the body background color, which may differ from widget’s parent element
...
- Breaking change typo in modalNode attributes - should be _modalNode
